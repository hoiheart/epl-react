...
(async () => {
  ...
  try {
    ...
    await fs.mkdirSync('./public/static/data/statistics/', { recursive: true })
    await fs.writeFileSync('./public/static/data/statistics/statistics.json', JSON.stringify(json))
